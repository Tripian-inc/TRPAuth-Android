...
import com.tripian.aws_auth.exceptions.AuthClientException;
import com.tripian.aws_auth.exceptions.AuthInvalidGrantException;
import com.tripian.aws_auth.exceptions.AuthNavigationException;
import com.tripian.aws_auth.exceptions.AuthServiceException;
import com.tripian.aws_auth.handlers.AuthHandler;
import com.tripian.aws_auth.util.AuthHttpClient;
import com.tripian.aws_auth.util.AuthHttpResponseParser;
import com.tripian.aws_auth.util.ClientConstants;
import com.tripian.aws_auth.util.LocalDataManager;
import com.tripian.aws_auth.util.Pkce;
    ...
    private Map<String, String> getHttpHeader() {
        ...
        if (pool.getAppSecret() != null) {
            httpHeaderParams.put(ClientConstants.HTTP_HEADER_TYPE_AUTHORIZE, "Basic "
                    + Pkce.encodeBase64(pool.getAppId() + ":" + pool.getAppSecret()));
        }
